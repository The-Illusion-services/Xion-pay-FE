...
const PaymentStatusModals: React.FC<Props> = ({activeModal, setActiveModal, showModal, setShowModal}) => {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-gray_primary rounded-xl shadow-lg p-6 max-w-md w-full animate-in fade-in slide-in-from-bottom-4 duration-300">
            <div className="flex flex-col items-center text-center">
              ...
              <h2 className="text-xl font-semibold mb-2 text-white">Payment Failed</h2>
              <p className="text-white_primary mb-6">
...
{activeModal === 'noParams' && showModal && (
      ...
      {activeModal === 'processing' && showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-gray_primary rounded-xl shadow-lg p-6 max-w-md w-full animate-in fade-in slide-in-from-bottom-4 duration-300">
            <div className="flex flex-col items-center text-center">
              <div className="w-16 h-16 rounded-full flex items-center justify-center mb-4" style={{ backgroundColor: '#FFBF00' }}>
                <CgSpinnerTwo className="w-8 h-8 text-white animate-spin" />
              </div>
              <h2 className="text-xl font-semibold mb-2 text-white">Processing Payment</h2>
              <p className="text-white_primary mb-6">
